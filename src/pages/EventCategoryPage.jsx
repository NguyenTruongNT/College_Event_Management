...
function EventCategoryPage() {
  ...
  const currentDate = new Date("2025-09-11T13:45:00+07:00"); // Ngày và giờ hiện tại
  ...
  const allEvents = [
    ...
    },
    {
      ...
      date: "11/09/2025", // Đang diễn ra (cùng ngày hiện tại)
      time: "13:00 - 17:00",
  ...
  // Phân loại sự kiện dựa trên ngày hiện tại
          ...
          <div className="mb-3">
            ...
            >
              <small style={{ color: "#34495e" }}>
                Đăng ký: {event.registrations}/{event.capacity}
              </small>
      ...
      <div className="container-fluid p-4">
        <div className="row mb-4">
          <div className="col-12">
            <h3 className="mb-3">
              <i className="bi bi-list-ul me-2"></i>DANH SÁCH SỰ KIỆN
            </h3>
            <FilterBar></FilterBar>
            {/* <ul className="nav nav-pills mb-3" role="tablist">
              <li className="nav-item" role="presentation">
                ...
                >
                  <i className="bi bi-clock-fill me-1"></i>Sắp tới (
              ...
              <li className="nav-item" role="presentation">
                ...
                >
                  <i className="bi bi-play-circle-fill me-1"></i>Đang diễn ra (
              ...
              <li className="nav-item" role="presentation">
                ...
                >
                  <i className="bi bi-check-circle-fill me-1"></i>Đã kết thúc (
        ...
        <div className="tab-content">
          <div
            className={`tab-pane fade ${
              activeTab === "upcoming-events" ? "show active" : ""
            }`}
            id="upcoming-events"
          >
          ...
          <div
            className={`tab-pane fade ${
              activeTab === "ongoing-events" ? "show active" : ""
            }`}
            id="ongoing-events"
          >
          ...
          <div
            className={`tab-pane fade ${
              activeTab === "completed-events" ? "show active" : ""
            }`}
            id="completed-events"
          >
